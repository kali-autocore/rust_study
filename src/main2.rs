                        ...
                        // 循环group，给Light赋值
                        {
                            ...
                            for (g_name, lgt_id_vec) in light_group.iter_mut(){
                                ...
                                if g_name ==  group_name {
                                    color = lgt_status.color;
                                } else {
                                    if lgt_id_vec.len() > 0 {
                                        let color_int: u64 = lgt_value[&lgt_id_vec[0].to_owned()].as_u64().unwrap();
                                        color = get_color(&color_int);
                                    }else {
                                ...
                                for lgt_id in lgt_id_vec {
                                    light_real_vec.push(Light{
                                        id: lgt_id.clone(), color: color
                                    });
                                }
                            }
                        }
