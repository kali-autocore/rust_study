...
// lazy_static! {
//     static mut RULEMESSAGE: RuleMessage = RuleMessage {
//         name: "".to_string(),
//         color: 1,
//         duration: 1,
//     }; 
...
// static mut LIGHTHASH: Lazy<LinkedHashMap<String, Light>> = Lazy::new(||{LinkedHashMap::new()});
// static mut LIGHTCONFIG: Lazy<Config> = Lazy::new(||{
//     Config{
//         road_id: String::from(""),
//         master: String::from(""),
...
async fn main() {
    ...
    let mut task: task::JoinHandle<()> = tokio::spawn(light_loop(light_hash, cfg));
